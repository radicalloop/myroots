...
export function getPersonLabel(person: Pick<TreePersonNode, 'first_name' | 'last_name'>): string {
...
export function initialsFor(person: Pick<TreePersonNode, 'first_name' | 'last_name'>): string {
...
export function toUpdatePersonPayload(values: PersonFormValues): UpdatePersonPayload {
  return {
    first_name: values.first_name.trim(),
    last_name: values.last_name.trim(),
